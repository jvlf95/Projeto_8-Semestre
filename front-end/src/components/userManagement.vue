    ...
    export default {
        ...
        methods: {
            async getUsers() {
                ...
                try {
                    const req = await fetch(`http://localhost:5000/user/all`);
            ...
            async deleteUser(user) {
                ...
                try {
                    const req = await fetch(`http://localhost:5000/user/delete/${user.id}`, { method: "DELETE" });
            ...
            async saveUser() {
                ...
                const url = isEditing ? `http://localhost:5000/user/update/${this.user.id}` : 'http://localhost:5000/user/add';
